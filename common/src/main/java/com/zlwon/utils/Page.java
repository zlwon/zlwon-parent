 ...
 * 分页对象。
 * <p>用于包含数据及分页信息的对象
 * <br> Page类实现了用于显示分页信息的基本方法，但未指定所含数据的类型， 可根据需要实现以特定方式组织数据的子类，
 * <br> 如RowSetPage以RowSet封装数据，ListPage以List封装数据
 *
 * <p>
...
public class Page<T> implements java.io.Serializable {
    ...
    public Page(int myPageSize, List<T> data, int curPage, int pageCount,
			int recordCount) {
		super();
